      ...
      render(){
          return(
              ...
              <div className="tc padding-top-most-of-interface" style={{paddingBottom:"10px"}}>
                <input autoComplete="off"  onChange={this.timeInput} className="tc" autoFocus="autofocus"  id="manualInput" type="number" style={{background:"RGB(23,23,23)", outline:"none", color:"white", height:"120px", width:"300px", fontSize:"100px"}}></input>
            </div>
              :
